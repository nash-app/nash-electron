...
export const NASH_LLM_SERVER_ENDPOINT = `http://localhost:${NASH_LLM_SERVER_PORT}/v1/chat/completions/stream`;
export const NASH_LLM_SUMMARIZE_ENDPOINT = `http://localhost:${NASH_LLM_SERVER_PORT}/v1/chat/summarize`;
